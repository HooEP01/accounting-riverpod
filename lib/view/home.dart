...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Widget build(BuildContext context) {
    AsyncValue<List<Item?>> contact = ref.watch(contactListProvider);
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ref.read(contactListProvider.notifier).fetchContact(contactType: "empty");
                // ref.read(contactProvider);
              },
              child: const Text('Press empty'),
            ),
            ElevatedButton(
              onPressed: () {
                if (kDebugMode) {
